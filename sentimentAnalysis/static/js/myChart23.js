...
!function (l) {
    ...
    class r {
        ...
        init() {
            var r = getChartColorsArray("#lineChart"), r = {
            ...
            r = getChartColorsArray("#doughnut"), r = {
                ...
                datasets: [{data: [300, 210], backgroundColor: r, hoverBackgroundColor: r, hoverBorderColor: "#fff"}]
            };
            this.respChart(l("#doughnut"), "Doughnut", r);
            r = getChartColorsArray("#pie"), r = {
                labels: ["Desktops", "Tablets"],
                datasets: [{data: [300, 180], backgroundColor: r, hoverBackgroundColor: r, hoverBorderColor: "#fff"}]
            };
